      ...
      <a href={linkProduct} target="_blank" rel="noopener noreferrer">
        <div className="relative mb-4 overflow-hidden">
          <img
            src={imageURL}
            alt={title}
            className="h-[120px] w-full rounded-md lg:h-[150px]"
          />
        </div>
        <div className="px-1">
          <h3 className="line-clamp-2 text-sm font-semibold lg:text-base">
            {title}
          </h3>
          <p className="text-sm font-semibold text-green-500 lg:text-base">
